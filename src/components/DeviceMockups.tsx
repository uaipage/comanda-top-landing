...
const DeviceMockups = () => {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      <div className="absolute w-40 h-40 bg-comandatop-blue/10 rounded-full -top-10 -left-10 filter blur-xl animate-pulse-soft" />
      <div className="absolute w-40 h-40 bg-comandatop-orange/10 rounded-full -bottom-10 -right-10 filter blur-xl animate-pulse-soft" />
      ...
      >
        <div className="bg-gray-900 w-full h-full rounded-xl p-3">
          <div className="device-screen w-full h-full bg-white rounded-lg flex flex-col">
            <div className="bg-comandatop-blue h-14 flex items-center px-4 rounded-t-lg">
              <div className="flex space-x-2">
                <div className="w-3 h-3 rounded-full bg-red-500"/>
                <div className="w-3 h-3 rounded-full bg-yellow-500"/>
                <div className="w-3 h-3 rounded-full bg-green-500"/>
              </div>
              <div className="text-white text-sm font-medium mx-auto">Painel Administrativo comandatop</div>
            </div>
            <div className="flex-1 p-4">
              <div className="grid grid-cols-3 gap-4 h-full">
                <div className="col-span-2 bg-gray-100 rounded-lg p-3">
                  <div className="h-6 w-32 bg-comandatop-blue/20 rounded-md mb-3"></div>
                  <div className="grid grid-cols-3 gap-3">
                    {[...Array(6)].map((_, i) => (
                      <div key={i} className="bg-white p-2 rounded shadow flex flex-col justify-between h-24">
                        <div className="h-2 w-12 bg-gray-200 rounded"></div>
                        <div className="h-8 w-full bg-comandatop-blue/10 rounded-md"></div>
                ...
                <div className="bg-gray-100 rounded-lg p-3 flex flex-col">
                  <div className="h-6 w-24 bg-comandatop-orange/20 rounded-md mb-3"></div>
                  <div className="flex-1 bg-white rounded-lg p-2 shadow">
                    {[...Array(4)].map((_, i) => (
                      <div key={i} className="flex items-center py-2 border-b border-gray-100">
                        ...
                        <div className="h-5 w-10 bg-comandatop-blue/10 rounded"></div>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      >
        <div className="bg-gray-900 w-full h-full rounded-2xl p-2 relative">
          ...
          <div className="device-screen w-full h-full bg-white rounded-xl flex flex-col">
            <div className="bg-comandatop-blue h-8 flex items-center justify-center rounded-t-xl">
            ...
            <div className="flex-1 p-3">
              ...
              {[...Array(4)].map((_, i) => (
                <div key={i} className="bg-gray-100 mb-2 p-2 rounded-lg flex justify-between">
                  ...
                  <div className="h-6 w-6 rounded-full bg-comandatop-orange/20 flex items-center justify-center">
                    <div className="h-3 w-3 rounded-full bg-comandatop-orange"></div>
                  </div>
                </div>
              ))}
              <div className="absolute bottom-2 left-2 right-2">
                <div className="h-8 bg-comandatop-blue rounded-lg flex items-center justify-center">
      ...
      >
        <div className="bg-gray-900 w-full h-full rounded-2xl p-2 relative">
          ...
          <div className="device-screen w-full h-full bg-white rounded-xl flex flex-col">
            <div className="h-6 bg-comandatop-orange flex items-center justify-center rounded-t-xl">
              <div className="text-white text-xs font-medium">comandatop</div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-1 mb-2">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="bg-gray-100 p-1 rounded flex flex-col items-center h-16">
                    ...
                    <div className="h-8 w-8 rounded-full bg-comandatop-blue/10 flex items-center justify-center">
                      <div className="h-4 w-4 rounded-full bg-comandatop-blue/30"></div>
                    </div>
                  </div>
                ))}
              </div>
              <div className="absolute bottom-2 left-2 right-2">
                <div className="h-6 bg-comandatop-orange rounded-lg flex items-center justify-center">
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex space-x-8 z-20">
        <div className="flex flex-col items-center opacity-70">
          <Tablet className="h-6 w-6 text-comandatop-blue" />
          <div className="text-xs text-gray-700 mt-1">Garçons</div>
        </div>
        <div className="flex flex-col items-center opacity-70">
          <Smartphone className="h-6 w-6 text-comandatop-orange" />
          <div className="text-xs text-gray-700 mt-1">App Móvel</div>
        </div>
        <div className="flex flex-col items-center opacity-70">
          <MonitorSmartphone className="h-6 w-6 text-comandatop-blue-dark" />
